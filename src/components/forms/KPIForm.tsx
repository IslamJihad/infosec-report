    ...
    <div className="animate-fadeIn">
      <FormCard icon="📊" title="مؤشرات الأداء الرئيسية">
        ...
        <div className="grid grid-cols-2 gap-3.5">
          {/* Current Values */}
          <div>
            <p className="text-[10px] font-[800] text-navy-950 mb-2">القيم الحالية</p>
          ...
          {/* Previous Values */}
          <div>
            <p className="text-[10px] font-[800] text-navy-950 mb-2">قيم الفترة السابقة</p>
            <div className="grid grid-cols-2 gap-2.5 mb-2.5">
        ...
        {/* Live Delta Preview */}
        <div className="mt-3 p-2.5 bg-navy-50 rounded-lg border border-border">
          <p className="text-[9px] font-bold text-text-muted mb-2">معاينة التغيير</p>
            ...
            {[
              ...
              return (
                <div key={item.label} className="text-center">
                  <div className="text-lg font-[900] text-navy-950">{item.current}</div>
                  <div className="text-[9px] text-text-muted">{item.label}</div>
                  <span className={`inline-block text-[9px] px-1.5 py-0.5 rounded mt-1 font-bold ${info.colorClass}`}>
        ...
        <hr className="my-3 border-none border-t border-border" />

        <div className="grid grid-cols-2 gap-3.5">
          {/* Vulnerability Distribution */}
          <div>
            <p className="text-[10px] font-[800] text-navy-950 mb-2">توزيع الثغرات</p>
            <div className="grid grid-cols-2 gap-2.5 mb-2.5">
          ...
          {/* Incident Status */}
          <div>
            <p className="text-[10px] font-[800] text-navy-950 mb-2">حالة الحوادث</p>
            <div className="grid grid-cols-2 gap-2.5 mb-2.5">
