...
export const NAV_ITEMS = [
  ...
  { icon: '🏛️', label: 'حماية الأصول الحيوية', key: 2 },
  { icon: '📊', label: 'المؤشرات والاتجاهات', key: 3 },
  { icon: '💰', label: 'فعالية الاستثمار', key: 4 },
  { icon: '⏱️', label: 'مقاييس الاستجابة', key: 5 },
  { icon: '⚠️', label: 'المخاطر الرئيسية', key: 6 },
  { icon: '🧭', label: 'مستوى النضج', key: 7 },
  { icon: '🚧', label: 'التحديات والعوائق', key: 8 },
  { icon: '✅', label: 'التوصيات', key: 9 },
];
